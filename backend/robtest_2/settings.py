"""
Django settings for robtest_2 project.
...
WSGI_APPLICATION = 'robtest_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "robtest_2 API",
    "DESCRIPTION": "API documentation for robtest_2 App",
    "VERSION": "v1",
}
